...
impl AuditLogger {
    ...
    pub fn command_executed(&self, agent_id: &str, request_id: Option<&str>, command_id: &str, name: &str) {
    ...
    pub fn internal_error(&self, agent_id: Option<&str>, request_id: Option<&str>, error_msg: &str) {
